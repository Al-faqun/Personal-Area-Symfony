$(document).ready(function() {
        $("#edit_form").on('submit', function (event) {
            ...
            $.ajax({
                type: 'post',
                url: Routing.generate('edit_cargo'),
...
function openEditDialog(cargoID){
    ...
    var string = $("#cargo_" + cargoID + "_datearrival")[0].innerHTML;
    $("#date_arrival")[0].value = string.replace(' ', 'T');
    $("#cargo_status")[0].value = $("#cargo_" + cargoID + "_status")[0].innerHTML;
